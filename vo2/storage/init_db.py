...
'''
tables = []
tables.append("CREATE TABLE catalog (sample_id INTEGER, path TEXT UNIQUE, name TEXT, set_id INTEGER, state INTEGER, finished_at DATETIME, PRIMARY KEY(sample_id))")
