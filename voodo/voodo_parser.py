...
class VoodoParser(BaseParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('-d', '--debug', default='INFO', help='Indicates debug level. CRITICAL, ERROR, WARNING (default), INFO, or DEBUG')
...
class JobParser(BaseParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--lib', default='', help='optional: Specifies a library name (source of sample sets/catalogs)')
        ...
        self.parser.add_argument('--path', default='', help='optional: Set the path for a library or catalog, for example')
        ...
        self.parser.add_argument('-s', '--set', default='',
                            help='optional: Specify a sample set name. A set is a catalog, or sample set of artifacts')
